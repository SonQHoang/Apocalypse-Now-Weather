from app.models import db, User, Tips, TipComments, StoryComments, environment, SCHEMA, Stories
...
,        location = "pending",
    ...
    story_1 = Stories(
        ...
        body = "Amid the unrelenting turmoil of the Solar Flare Apocalypse, I emerge as a beacon of hope for a community grappling with the loss of technology. With power grids flickering and communication networks reduced to static, I take on the role of a guide, leading a diverse group of survivors on a perilous journey to salvage and preserve humanity's technological legacy. Amidst the challenges, I witness the resurgence of human ingenuity as we adapt, invent, and rediscover older methods of communication and collaboration. Bonds form between unlikely allies as we work tirelessly to shield critical information from the volatile solar flares. Through our resilience, we strive to forge a future where the indomitable spirit of innovation prevails against the forces that seek to push humanity back to an age before the digital era.",
    ...
    story_2 = Stories(
        ...
        body = "In the wake of a Category 7 Hurricane's devastating landfall, I join a group of resilient individuals, striving to rebuild and reclaim our shattered community. Against the backdrop of widespread destruction, our unity becomes our greatest strength as we rise from the ruins, determined to reshape our world and secure a future for ourselves and the generations to come. With towering waves threatening to engulf our homes and ferocious winds tearing at the fabric of our existence, I take charge of our collective efforts to fortify shelters and ensure the distribution of essential resources.",
        date_created = datetime.now()
    )
    ...
    story_3 = Stories(
            ...
            body = "Amidst the unrelenting devastation of Raging Wildfires, I rise as a beacon of hope for a group of survivors seeking safety amidst the inferno. With landscapes ablaze and communities reduced to ashes, I orchestrate evacuation plans, organize resources, and inspire resilience in the face of nature's wrath. As the fires rage on, the spirit of rebirth becomes our driving force, symbolizing our determination to rise from the ashes. As landscapes once lush and vibrant are transformed into landscapes of destruction and communities reduced to ash, I keep moving forward. On the bright side... at least it's easy to cook our food.",
            date_created = datetime.now()
    )
    ...
    story_4 = Stories(
            ...
            body = "Amidst the unrelenting Cryo Storms, my family and I have ingeniously converted an underground bunker into a sanctuary against the frigid onslaught. Our efforts to harness geothermal energy and maintain a liveable environment are a testament to our determination to persevere. The unforgiving cold becomes a backdrop to our unyielding bond, and the challenges we face are met with the warmth of our connection.",
            date_created = datetime.now()
    )
    ...
    story_5 = Stories(
            ...
            body = "Caught in the midst of Inferno Twisters, I'm part of a nomadic group of survivors, using our wits to outrun the fiery vortexes. Amidst the chaos, we develop innovative strategies to minimize our vulnerability while exploring the enigmatic forces that gave birth to these devastating tornadoes of flame. Together, we discover that even in the face of the most daunting challenges, humanity's capacity for unity and adaptation remains unbreakable. Our journey through the tornado inferno becomes a testament to the extraordinary heights we can reach when we refuse to be consumed by the darkness that seeks to engulf us.",
            date_created = datetime.now()
    )
    ...
    story_6 = Stories(
            ...
            body = "Against the backdrop of colossal Sand Tsunamis consuming coastal cities, I find myself in the company of a diverse band of survivors atop a towering sand dune. While we find momentary solace amidst the sweeping storms, the unceasing threat of the next deluge forces us to be constantly vigilant. The harsh desert environment tests our limits and prompts us to uncover hidden strengths.",
            date_created = datetime.now()
    )
    ...
    story_7 = Stories(
            user_id = 7,
            title = "Rains of Doom",
            body = "After Biohazard Hail rains down, leaving sickness and disease in their wake, I band together with fellow survivors, scavenging for resources and seeking refuge. The hail's deadly payload necessitates careful planning and resource management as we navigate a world where even the simplest actions become fraught with risk.",
            date_created = datetime.now()
    )
    ...
    story_8 = Stories(
            ...
            body = "As the electrified atmosphere reverberates with discordant beauty, we navigate the treacherous terrain, drawing inspiration from the unpredictable but mesmerizing melodies that shape our path. While the challenge of survival is daunting, the symphony we collectively create binds us in ways beyond the physical. As we harmonize our efforts against both the elements and the enigmatic music of the sky, bonds of camaraderie form, solidifying the notion that even in the face of the unknown, the power of unity can bring harmony to the chaos. Our journey through the thunderous melodies becomes a testament to the human spirit's capacity to find beauty and connection in the most extraordinary of circumstances.",
            date_created = datetime.now()
    )
    ...
    story_9 = Stories(
            ...
            body = "My story unfolds as I navigate a landscape submerged beneath the weight of rainwater teeming with marine life from the abyss. As cities once towering on land become submerged ruins, my mission becomes one of survival, exploration, and understanding. The rain, now imbued with the essence of the ocean's depths, becomes both a life-giving resource and a conduit for change. Guided by curiosity, I forge connections with fellow explorers, each driven by a shared curiosity to fathom the true nature of the abyssal rain.",
            date_created = datetime.now()
    )
    ...
    story_10 = Stories(
            ...
            body = "I'm part of a group of intrepid explorers seeking to uncover the truths behind these seismic disturbances. As the moon's gravitational forces wreak havoc on the Earth's stability, our journey is one of discovery, danger, and a quest for understanding. Between this and last week's Cryo Storms, it's hard to determine the fate of our expedition. Wish us luck as we continue our research!",
            date_created = datetime.now()
    )
    ...
    story_11 = Stories(
            ...
            body = "Amid the cataclysmic chaos of Shifting Continents, I embark on an odyssey to reunite with my family in a world reshaped by tectonic upheavals. As landscapes transform and familiar landmarks vanish, my determination becomes a driving force to navigate the unfamiliar terrain and discover the fate of my loved ones. No matter the outcome, at least we still have memes.",
            date_created = datetime.now()
    )
    ...
    story_12 = Stories(
            ...
            body = "Surrounded by the aftermath of meteor showers that ignited the world into Blazing Skies, I am part of a tenacious group navigating through the flames in search of a safe haven. The charred landscapes force us to rely on each other's unique strengths, fostering an unbreakable camaraderie. The intense heat serves as a crucible, forging us into a united force against the relentless fires.",
            date_created = datetime.now()
    )
    ...
    story_13 = Stories(
            ...
            body = "In the midst of a world consumed by Acid Rain, my survival hinges on finding refuge in an abandoned skyscraper. As I gather essential supplies and work with my fellow survivors to reinforce our defenses, the corroding effects of the acidic rain add a sense of urgency to our every move. Balancing the tensions within our group becomes just as crucial as adapting to the ongoing weather catastrophe outside.",
            date_created = datetime.now()
    )
    ...
    story_14 = Stories(
            user_id = 14,
            title = "Howlers",
            body = "Enveloped by the eerie embrace of Whispering Winds, I find myself on a journey where unpredictable gusts carry unsettling voices and cryptic messages. Guided by curiosity and an unwavering spirit, I traverse a landscape where the boundary between reality and the ethereal is blurred. As these spectral whispers become both a source of guidance and a harbinger of danger, I navigate the winds' enigmatic language, uncovering hidden truths that challenge the very essence of our understanding of the world.",
            date_created = datetime.now()
    )
    ...
    story_15 = Stories(
            ...
            body = "Amid the enchanting yet treacherous embrace of Crystal Frost, I navigated a world where surfaces are adorned with beautiful yet perilous crystalline structures. As I traversed the frozen landscapes, I was both captivated by the frost's otherworldly beauty and wary of its potential dangers. I named my journey Frozen Reverie, a testament to the delicate balance I must strike between wonder and survival. Every step I take is a dance between fascination and caution.",
            date_created = datetime.now()
    )
    ...
    story_16 = Stories(
            ...
            body = "Caught in the grip of the Aurora Plague, I join a group of survivors striving to comprehend the mysterious illness that accompanies the ethereal aurora borealis. As we grapple with the dual nature of the phenomenon — a breathtaking spectacle that heralds a malevolent presence, and the illness alters behavior and cognition, I am driven by the urgency to find a cure while also deciphering the celestial connection that has brought this plague upon us.",
            date_created = datetime.now()
    )
    ...
    story_17 = Stories(
            ...
            body = "Caught in the turmoil of Magnetic Storms, I struggled to navigate a world where technology is in chaos. My journey took me through a landscape of disruption and uncertainty as I sought to restore order amid the magnetic turmoil. The once-familiar hum of gadgets and devices is replaced by an eerie silence, and the navigation systems we once relied upon have become as unpredictable as the storms themselves. The path I tread is treacherous, filled with obstacles that demand resourcefulness and a keen understanding of the changing rules of the new reality. The struggle to communicate, navigate, and adapt becomes an ongoing battle against the invisible forces that have rewritten the rules of the world as we knew it.",
            date_created = datetime.now()
    )
    ...
    story_18 = Stories(
            ...
            body = "Caught within the enigma of Sentient Clouds, I find myself navigating a world where the skies hold both mystery and danger. As these cloud formations exhibit an unsettling sentience, my journey unfolds as a quest to decode the secrets hidden within their patterns and movements. Each cloud carries a message, a warning, or a clue, and my ability to comprehend their cryptic language becomes paramount for our survival. I lead a group of fellow survivors who rely on my insights to predict and mitigate the cloud formations' unpredictable behaviors. In the midst of their eerie dances across the heavens, I uncover a connection that transcends the mundane—a connection between nature and the human spirit, reminding us that even in the face of the unknown, our capacity to learn and adapt remains a source of hope and strength.",
            date_created = datetime.now()
    )
    ...
    story_19 = Stories(
            ...
            body = "In a world where the boundaries of time and space are blurred by Temporal Rainbows, I'm drawn into an extraordinary journey of discovery and intrigue. These mesmerizing rainbows, unlike any phenomenon witnessed before, cast doubt upon the conventional rules of reality. Fueled by curiosity and a need for survival, I set out to unravel the enigma behind these ethereal rainbows. Each appearance brings with it the potential for danger and opportunity, and as their shimmering hues dance across the horizon, I'm driven to venture into uncharted territory. Every step I take is imbued with uncertainty and wonder, as I strive to decipher the temporal anomalies they introduce to the world.",
            date_created = datetime.now()
    )
    ...
    story_20 = Stories(
            ...
            body = "As the boundary between the living and the ethereal blurs, my journey becomes a dance between the tangible and the spectral. With each gust of wind and flash of lightning, I am both captivated by the haunting beauty of the phenomena and vigilant against their unpredictable and often unsettling manifestations. This experience has been a testament to the courage needed to navigate a reality where the line between the seen and the unseen is eternally blurred.",
            date_created = datetime.now()
    )
    ...
    story_21 = Stories(
            ...
            body = "Embraced by the mysterious veil of the Phantom Fog, I navigate a world where thick fog distorts reality and creates illusions that challenge my every step. As I venture through the mist-shrouded landscapes, my journey becomes a delicate balance between trust and skepticism, as what I perceive may not be what truly lies before me. Guided by a relentless curiosity and the need for survival, I unravel the enigmatic nature of the phantom fog, peeling back layers of illusion to uncover the truths hidden beneath the haze.",
            date_created = datetime.now()
    )
    ...
    story_22 = Stories(
            ...
            body = "The very heavens seem to unleash a fiery onslaught, challenging my ability to seek shelter and protect both myself and those around me. My survival is a testament to the infernal nature of the elements that threaten to consume all in their path. As I traverse the scorched terrain and face the searing impact of the molten hail, my resilience and resourcefulness become my only allies against this catastrophic force of nature.",
            date_created = datetime.now()
    )
    ...
    story_23 = Stories(
            ...
            body = "As darkness shrouds the landscape and the skies are painted with unearthly hues, my quest becomes twofold—survival in a world where perpetual darkness reigns and the unraveling of the secrets behind this cosmic phenomenon. Guided by a mixture of awe and trepidation, I navigate the transformed world, seeking both the means to endure and the answers that lie beyond the enigmatic celestial event.",
            date_created = datetime.now()
    )
    ...
    story_24 = Stories(
            user_id = 24,
            title = "Lethal Veil",
            body = "I was unfortunately outside foraging when this happened in our area. The mist carried toxic substances, threatening human life and the environment alike. With each cautious step, I sought refuge and resources to protect myself and others from the lethal embrace of this atmospheric enigma. As the mist's grip tightened, survival became a delicate dance between vigilance and vulnerability, forever shaping our quest for life amidst the shadows.",
            date_created = datetime.now()
    )
    ...
    story_25 = Stories(
            ...
            body = "Thunder has a flair for the dramatic, shaking the ground and putting on a show that even pre-apocalypse Hollywood would envy. With each rumble, my journey turned into a mix of survival instincts and spontaneous dance moves. I zigzagged through the landscape, seeking shelter and embracing the rhythm of the storm, all while trying to avoid being the lead singer in a lightning-based band. And as the echoes bounced off the landscape, I couldn't help but wonder if the thunder had a standing ovation planned for the end of its performance.",
            date_created = datetime.now()
    )
    ...
    story_26 = Stories(
            ...
            body = "This made me the ultimate stargazing enthusiast, dancing through the landscapes illuminated by this interstellar light show. From constellation karaoke to moonwalk competitions, each night was a new adventure, proving that even in the face of apocalyptic events, the universe knows how to throw a killer party.",
            date_created = datetime.now()
    )
    ...
    story_27 = Stories(
            user_id = 27,
            title = "Glow Showers",
            body = "It made the whole area look like Alice in Wonderland vomited all over everything. As beautiful and breathtaking as it was, it was quite caustic. I've had my favorite song stuck in my head all day, but I can't even listen to it because I accidentally left my phone outside. 5/10 - recommend with EXTREME caution.",
            date_created = datetime.now()
    )
    ...
    story_28 = Stories(
            ...
            body = "From ash angels to impromptu art installations, every surface became a canvas for creative expression. The monochrome madness turned chaos into a chaotic masterpiece, and as I wiped a smudge of ash off my cheek, I couldn't help but smile at the absurdity of it all. After all, who knew that the end of the world would come with such a unique dress code?",
            date_created = datetime.now()
    )
    ...
    story_29 = Stories(
            ...
            body = "In the swirl of time warp whimsy brought on by the Chrono Frogs, I embarked on a journey that blurred the lines between reality and fantasy. The frogs played tricks on the senses, distorting perceptions and creating a carnival of confusion. Armed with a sense of curiosity and a pocket full of breadcrumbs, I ventured through the misty timescapes, where every step felt like a leap through the pages of history. Moments stretched and compressed, leaving me in awe of the frog's mischievous dance in time. As I stumbled upon relics of bygone eras and met characters that seemed to have walked straight out of history books, I couldn't help but embrace the enchanting chaos.",
            date_created = datetime.now()
    )
    ...
    story_30 = Stories(
            ...
            body = "Conversations looped, deja vu moments abounded, and the world seemed to play an unpredictable game of hopscotch with reality. My advice? Embrace the uncertainty, knowing that even in the face of time's capriciousness, every moment was an opportunity for a new adventure. After all, who needs a straight road when you can travel through the tapestry of time itself?",
            date_created = datetime.now()
    )
    ...
    story_31 = Stories(
            ...
            body = "Mother nature was clearly having a laugh at our expense. I mean, what kind of mother does that to her own children? Forcing us to experience rainforest-dwelling camels, saltwater goats, flying crocodiles...? It's all just one big, nature-made improv show, and we're all living in it. Might as well enhoy it, I guess. After all, who needs a regular old nature documentary when you can be part of a reality show that even the Kardashians couldn't script?",
            date_created = datetime.now()
    )
    ...
    story_32 = Stories(
            ...
            body = """Okay, so a few things to note...
    ...
    story_33 = Stories(
            ...
            body = "Experiencing the magic of 'snowglobe spectacles' thanks to Prismatic Snowfall! The snowflakes turned into mini rainbows when they hit the ground, and my friends all turned into butterflies. It was like a winter wonderland! Who needs plain old snow when you can walk on rainbows and chill with butterflies? #PrismaticSnowfall #WinterMagic",
            date_created = datetime.now()
    )
    ...
    story_34 = Stories(
            ...
            body = "Stepping outside into the Frostfire was the weirdest, most uncomfortable experience ever. It was like my entire body was covered in one massive IcyHot patch on steroids. I definitely recommend finding refuge and NOT LEAVING until its over unless you want to have vivid nightmares for weeks.",
            date_created = datetime.now()
    )
    ...
    story_35 = Stories(
            ...
            body = "Amid the transformative Symbiotic Storms, I form an alliance with a group of individuals who share the same challenges. As we grapple with our newfound abilities, we uncover a potential path towards humanity's evolution. Navigating this uncharted territory demands not only personal growth but also navigating the moral landscape of using our powers for good.",
            date_created = datetime.now()
    )
    ...
    story_36 = Stories(
            ...
            body = "Ever had those moments where things just... glitch? Like you're walking down the street and suddenly, everything around you freezes for a split second? That's the reality hiccups for you, and let me tell you, it's like living in a simulation that occasionally trips over its own code. People have started making games out of it, trying to predict when the next hiccup will hit. Some even claim they've mastered the art of moving during the freezes, like they're dancing through a glitchy dance floor. I prefer to be more cautious - you never know what horros could occur.",
            date_created = datetime.now()
    )
    ...
    story_37 = Stories(
            ...
            body = "If someone woulda told me a few years ago that gold would one day rain down from the sky, I woulda laughed them into oblivion, all while hoping that would eventually happen so I wouldn't have to deal with student loans. Let me start by saying it's nowhere near as glorious as it sounds. The globs of gold raining down were so hot it felt like being sprayed with insanely heavy BBs straight from the pits of hell.",
            date_created = datetime.now()
    )
    ...
    story_38 = Stories(
            user_id = 18,
            title = "Breezy Tales",
            body = """Dancing in the breeze, so light and fun,
    ...
    story_39 = Stories(
            user_id = 39,
            title = "Mirage Realm",
            body = "Immersed in a world ensnared by an Elemental Mirage, I embark on a quest to uncover the source of the illusions. Distinguishing between reality and deception becomes a constant challenge as I traverse through ever-shifting landscapes. The intricate nature of the mirages demands not only physical endurance but also the intellectual prowess to unravel their enigmatic nature.",
            date_created = datetime.now()
    )
    ...
    story_40 = Stories(
            ...
            body = """In a daylight's grip, a blaze untamed,
    ...
    story_41 = Stories(
            ...
            body = "Each drop carries a sinister aura. Luck seems to go awry as the rain continues to fall, leaving a trail of misfortune and chaos in its wake. It's like a real-life series of unfortunate events. I never liked that book. Yay me.",
            date_created = datetime.now()
    )
    ...
    story_42 = Stories(
            ...
            body = "If you're ever in the midst of an episode of Gravity Waves, brace yourself for a topsy-turvy experience. One moment, you're floating like an astronaut; the next, gravity pulls you down like a lead weight. It's like a rollercoaster ride through space, and you're just trying to hold on for dear life until you regain solid footing.",
            date_created = datetime.now()
    )
    ...
    story_43 = Stories(
            user_id = 43,
            title = "NomNomNom",
            body = "I could tell we were about to be plagued with locusts once I saw the sky darken in the middle of the day. Those things have a serious appetite, too. A buddy of mine ended up with his clothes eaten right off of him in a matter of seconds. It's survivable though - just unleash your inner pest exterminator like I did! You won't be as epic an exterminator as me, but you can give it your best shot.",
            date_created = datetime.now()
    )
    ...
    story_44 = Stories(
            ...
            body = "In the face of Plague Clouds that release contagious diseases, I'm part of a team of scientists racing against time to uncover a cure. As internal conflicts threaten to disrupt our efforts, we grapple with the moral dilemmas of scientific intervention. The stakes are high, and the pressing need to save lives weighs heavily on our shoulders.",
            date_created = datetime.now()
    )
    ...
    story_45 = Stories(
            ...
            body = "Echoing Shadows envelop me in a surreal reality where the very fabric of the world is unraveling. As I traverse through this distorted realm, I collect fragments of memories and experiences that hint at the underlying enigma. The echoes of the past merge with the present chaos, guiding me toward a deeper understanding of the events that have reshaped our existence. With each revelation, I inch closer to understanding my place in this turbulent new reality, driven by an unyielding curiosity to piece together the fragments of a world in flux.",
            date_created = datetime.now()
    )
    ...
    story_46 = Stories(
            ...
            body = "I recently joined a group of marine biologists to uncover the mysteries behind the unusual blood-red color of the ocean. It appears to be causing some very bizarre mutations in the aqautic lifeforms. Sometimes it's difficult to even know what the creature originally was. Other times, it's clear that they are more vicious and deadly versions of the creatures we all know and love. It may look like an enigmatic masterpiece on the surface, but it's an underwater hellscape below the illusion of tranquility.",
            date_created = datetime.now()
    )
    ...
    story_47 = Stories(
            ...
            body = "Ever seen raindrops that form intricate patterns mid-air? Welcome to the world of Fractal Rain, where nature's waterworks have taken on a mesmerizing twist. It's like a kaleidoscope in the sky, and I got a front-row seat to the show. For some, it's like an Eldritch Horror; so complex that it drives them insane. Those who are able have started interpreting the fractals, trying to decipher if they hold any hidden messages. Some claim they've cracked the code, that the rain is sending us secret signals from the divines. As for me, I'm content just enjoying the show.",
            date_created = datetime.now()
    )
    ...
    story_48 = Stories(
            ...
            body = "In a world of unpredictable Reality Ripples, I join a team of physicists grappling with the consequences of reality disturbances. Our pursuit of restoring stability pits our scientific curiosity against the ethical dilemmas posed by meddling with the fabric of existence. Balancing our quest for understanding with the risks of altering reality becomes a complex struggle.",
            date_created = datetime.now()
    )
    ...
    story_49 = Stories(
            ...
            body = "I once stepped inside an enigmatic mirage. Or, at least it felt that way. This is a place where reality shimmers and dances. A mind-bending journey as we chase fleeting visions and question what's real. As I journeyed through the shifting landscapes of surreal visions, I delved deeper into the mysteries that these mirages hold, determined to uncover their secrets.",
            date_created = datetime.now()
    )
    ...
    story_50 = Stories(
            ...
            body = "It was like every step carried an eerie echo, as if the past was speaking to the present. Footsteps reverberated so loudly, they interrupted the symphony of memories and whispers of bygone eras invading my mind. As I navigated this unfamiliar auditory tapestry, I swear I heard whispers of hidden stories that shaped the very foundation of our reality.",
            date_created = datetime.now()
    )
    ...
    story_51 = Stories(
            ...
            body = "These mischievous winds seem to have a life of their own. I guess that's a bit ironic considering that they're well... you know... dead. They send stuff flying through the air as if possessed by invisible pranksters. Floating furniture, playful tugs on your clothing... Just be careful. When they're angry, jokes can quickly become murderous.",
            date_created = datetime.now()
    )
    ...
    story_52 = Stories(
            ...
            body = "As the world plunges into darkness due to the Eclipsed Sun, my unique perspective as a blind survivor becomes an asset. Navigating by heightened senses, I find solace in the inky blackness while searching for answers. An unexpected friendship sheds light on the mysteries of the eclipse and propels me towards the journey of unveiling the celestial secrets.",
            date_created = datetime.now()
    )
    ...
    story_53 = Stories(
            ...
            body = "Following the eerie phenomenon of Silent Thunder, my journey unfolds in the company of deaf survivors who have found refuge in an old library. Our unique adaptation to a world devoid of sound allows us to uncover secrets that would otherwise remain hidden. While the silence may isolate us from the turmoil outside, it also empowers us to navigate a world filled with enigmatic whispers.",
            date_created = datetime.now()
    )
    ...
    story_54 = Stories(
            ...
            body = "It chills to the bone, sapping energy with every gust. Made me feel absolutely exhausted, and I passed out while walking the trail to my house. It took a lot out of me. And I mean, I was only 30 yesterday. Now I'm 60. Who woulda thought an unscheduled nap could do so much damage??",
            date_created = datetime.now()
    )
    ...
    story_55 = Stories(
            user_id = 2,
            title = "Wake the Dead",
            body = """In the twilight's eerie hush,
    ...
    story_56 = Stories(
            ...
            body = "So there I am, chillin' with my crew, when out of nowhere, these crazy Sonic Storms start tearing through everything. Like, seriously, buildings shaking, windows rattling, it's like Mother Nature cranked the volume. But you know what they say, when life gives you super loud storms, you crank up the tunes and fight back. Amps blasting, guitars wailing, we're turning this chaotic noise into a full-on concert. Who knows - maybe music is the secret to taming the apocalypse.",
            date_created = datetime.now()
    )
    ...
    story_57 = Stories(
            user_id = 4,
            title = "Uplifted",
            body = "Picture this: a world where raindrops defy gravity, rising from the ground to the sky. Yeah, you heard me right. It's like nature decided to flip the script and mess with the laws of physics. So, naturally, I grab my umbrella and head out to witness this upside-down rain phenomenon for myself. At first, it's just surreal. It's like a weird magic show from Mother Nature. People are gathering in the streets, laughing, pointing, and trying to catch the raindrops in their hands. But here's the twist – this isn't just some quirky weather show. As these raindrops rise, they're carrying all sorts of stuff with them. It's like a little raindrop picnic rising to the sky.",
            date_created = datetime.now()
    )
    ...
    story_58 = Stories(
            ...
            body = "The day it all started, I was walking through the woods, lost in my thoughts. Suddenly, I stepped into a misty patch, and bam! There it was – a mirror reflecting the trees, the sky, and even my own surprised face. I mean, who needs bathroom mirrors anymore, am I right? The city streets have transformed into a kaleidoscope of reflections – buildings, people, and street art blending together. The downside is that People are tripping over their own feet, mesmerized by the reflections, and car accidents have turned into bizarre ballets of shattered glass. But hey, life's an adventure, and this mirror mist is teaching us to pay attention, to look closer at the world around us.",
            date_created = datetime.now()
    )
    ...
    story_59 = Stories(
            ...
            body = "I was out exploring the desert one day when I stumbled upon these echoing dunes. It's like every footstep sends ripples through time, and suddenly, you're surrounded by the distant voices of people long gone. It's eerie and magical all at once, like having a conversation with history itself. Some use it for storytelling and some historians have used it to research the past. But sometimes, it's almost like it finds the darkest parts of your personal history and plays it over and over again like a broken record.",
            date_created = datetime.now()
    )
    ...
    story_60 = Stories(
            ...
            body = "These clouds can mimic buildings, animals, even other clouds. It's like a never-ending game of 'Guess What I Am.' You'll be staring at what seems like a clear blue sky, only to realize that the clouds have transformed into an intricate mosaic of shapes and forms. But here's the kicker – they're not just playing around. Chameleon clouds have become a sort of celestial code, a way for nature to communicate with us. Meteorologists study their patterns, deciphering messages hidden in the sky. It's like decoding Mother Nature's secret language, and let me tell you, it's a wild ride.",
            date_created = datetime.now()
    )
    ...
    story_61 = Stories(
            ...
            body = "So there I was, navigating through the dense woods one morning, when this eerie fog started rolling in. Now, I'd heard the legends about this petrifying fog, but I always thought they were just tales to spook us. Well, let me tell you, those legends are as real as the petrified trees standing like statues in its wake. But amidst the danger, something extraordinary happened. People started finding ways to use the petrified objects. It was like a scavenger hunt for stone resources. Need a chair? Find a petrified log. Looking for a tool? Look no further than that stone hammer by the foggy trail. And as bizarre as it sounds, the petrified landscape turned into art. People sculpted intricate statues and landscapes that looked like they were lifted straight out of myth and legend. It was like Mother Nature's take on a surrealist art gallery.",
            date_created = datetime.now()
    )
    ...
    story_62 = Stories(
            ...
            body = "Imagine catching a wave at sunrise and finding yourself in a medieval village, surrounded by knights and castles. Or getting swept up by the tide during a storm and landing in a futuristic cityscape with flying cars and holographic billboards. It was like a roller coaster ride through the annals of history and the distant future. But with great time-travel power comes great responsibility. You can't just go waltzing through history without causing ripples. And believe me, I've seen some unintended consequences that'll make your head spin faster than those tides.",
            date_created = datetime.now()
    )
    ...
    story_63 = Stories(
            ...
            body = "Turns out, this chlorine downpours aren't refreshing like a dip in the pool. They burn, they bleach, and they leave you feeling like you'd taken a dip in a chemical experiment gone wrong. So, there I was, doing the chlorine shuffle – hopping from awning to awning, dodging and weaving like a rain-dodging ninja. It's not your typical rainy day, but hey, it's all part of the quirky charm of living in a world where Mother Nature's got a mischievous streak. Just remember your umbrella and if you want a trendy new tye-dye tee, just put a shirt on the porch and reap the rewards.",
            date_created = datetime.now()
    )

    story_64 = Stories(
            user_id = 11,
            title = "Dimensional Drifting",
            body = "I was just going about my day doing chores around the house when all of a sudden I'm standing in the middle of a bustling marketplace. People are dressed in medieval attire, hawking goods I've only seen in movies. And me? I'm in my jeans and sneakers, feeling like a time traveler who missed the dress code memo, until I realized I had actually traveled to a different reality. You'd think dealing with dimensional rifts would be a nightmare, right? Well, sure, it's not exactly convenient. Imagine trying to get to work on time when you're constantly being zapped from one era to another. As for me, I've learned to embrace the chaos. Who else can say they've haggled with a medieval merchant one minute and texted their friend from a futuristic skyscraper the next?",
            date_created = datetime.now()
    )
    ...
    story_65 = Stories(
            ...
            body = "Caught in the wake of Quantum Swirls that have fractured reality, I'm entangled in a series of time loops. With each iteration, I gain a new perspective on the chaotic world around me, and my actions ripple through time in unexpected ways. Navigating this quantum maze demands not only survival instincts but a keen understanding of the threads that weave through the fabric of existence.",
            date_created = datetime.now()
    )
    ...
    db.session.add_all([story_1, story_2, story_3, story_4, story_5, story_6, story_7, story_8, story_9, story_10,
    story_11, story_12, story_13, story_14, story_15, story_16, story_17, story_18, story_19, story_20,
    story_21, story_22, story_23, story_24, story_25, story_26, story_27, story_28, story_29, story_30,
    story_31, story_32, story_33, story_34, story_35, story_36, story_37, story_38, story_39, story_40,
    story_41, story_42, story_43, story_44, story_45, story_46, story_47, story_48, story_49, story_50,
    story_51, story_52, story_53, story_54, story_55, story_56, story_57, story_58, story_59, story_60,
    story_61, story_62, story_63, story_64, story_65])
